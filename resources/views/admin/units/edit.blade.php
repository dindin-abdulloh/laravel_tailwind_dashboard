        ...
        <div class="body flex flex-wrap">
            <div class="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 mb-3 md:pr-2 lg:pr-2 xl:pr-2">
                <div class="mb-3 mx-2">
                    ...
                    <div class="form-group">
                        <input type="text" id="name" name="name" class="{{ $errors->has('name') ? ' ' : '' }}" value="{{ old('name', $unit->name) }}" required>
                    </div>
                    @if($errors->has('name'))
            ...
            <div class="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 mb-3 md:pl-2 lg:pl-2 xl:pl-2">
                <div class="mb-3 mx-2">
                    ...
                    <div class="form-group">
                        <textarea id="description" name="description" class="{{ $errors->has('description') ? ' is-invalid' : '' }} w-full rounded-md border-none focus:outline-none" required>{{ old('description', $unit->description) }}</textarea>
                    </div>
...
{{-- discount penjualan buat 10%
pembulatan harga ke atas
print harus diperbaiki --}}
