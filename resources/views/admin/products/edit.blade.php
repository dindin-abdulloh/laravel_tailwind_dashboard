        ...
        <div class="body flex flex-wrap">
            <div class="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 mb-3 md:pr-2 lg:pr-2 xl:pr-2">
                <div class="mb-3 mx-2">
                    ...
                    <div class="form-group">
                        <input type="text" id="product_name" name="product_name" class="{{ $errors->has('product_name') ? ' is-invalid' : '' }}" value="{{ old('name', $product->product_name) }}" required>
                    </div>
                ...
                <div class="mt-3 mx-2">
                    ...
                    <div class="form-group">
                        <input type="number" id="purchase_price" name="purchase_price" class="{{ $errors->has('purchase_price') ? ' is-invalid' : '' }}" value="{{ old('purchase_price', $product->purchase_price) }}" required>
                    </div>
                ...
                <div class="mt-3 mx-2">
                    ...
                    <div class="form-group">
                        <input type="number" id="stock_quantity" name="stock_quantity" class="{{ $errors->has('stock_quantity') ? ' is-invalid' : '' }}" value="{{ old('stock_quantity', $product->stock_quantity) }}" required>
                    </div>
                ...
                <div class="mt-3 mx-2">
                    ...
                    <div class="form-group">
                        <input type="text" id="product_code" name="product_code" class="{{ $errors->has('product_code') ? ' is-invalid' : '' }}" value="{{ old('product_code', $product->product_code) }}" required>
                    </div>
            ...
            <div class="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 mb-3 md:pl-2 lg:pl-2 xl:pl-2">
                <div class="mt-3 mx-2">
                    ...
                    <select class="select2{{ $errors->has('category_id') ? ' is-invalid' : '' }}" name="category_id" id="category_id" multiple>
                        @foreach($category as $id => $cat)
                            <option value="{{ $id }}" {{ ($product->category_id ? $product->category_id : old('category_id')) == $id ? 'selected' : '' }}>{{ $cat }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mt-3 mx-2">
                    ...
                    <div class="form-group">
                        <input type="number" id="price" name="price" class="{{ $errors->has('price') ? ' is-invalid' : '' }}" value="{{ old('price', $product->price) }}" required>
                    </div>
                    @if($errors->has('price'))
                ...
                <div class="mt-3 mx-2">
                    ...
                    <select class="select2{{ $errors->has('supplier_id') ? ' is-invalid' : '' }}" name="supplier_id" id="supplier_id" multiple>
                        @foreach($supplier as $id => $sup)
                            <option value="{{ $id }}" {{ ($product->supplier_id ? $product->supplier_id : old('supplier_id')) == $id ? 'selected' : '' }}>{{ $sup }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mt-3 mx-2">
                    ...
                    <div class="form-group">
                        <input type="date" id="expired_date" name="expired_date" class="{{ $errors->has('expired_date') ? ' is-invalid' : '' }}" value="{{ old('expired_date', $product->expired_date) }}" required>
                    </div>
